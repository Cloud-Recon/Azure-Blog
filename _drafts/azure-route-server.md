...
If you want traffic from a spoke to reach your firewall, UDR.  
If you want to steer traffic through a NVA, UDR.  
If you want to override a default internet route, UDR.  
If you want to peer a VNet and keep it secure, UDR.  
If you're using Virtual WAN or ExpressRoute or Private Link, guess what — UDR.
